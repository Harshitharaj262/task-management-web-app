...
const Sidebar = ({ handleLogout }) => {
  return (
    <div className="bg-white text-gray-900 min-h-screen w-16 md:w-64 border-r border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white fixed top-0 left-0 flex flex-col justify-between">
      {/* Logo / Title */}
      <div>
