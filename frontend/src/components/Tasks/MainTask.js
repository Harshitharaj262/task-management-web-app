...
export default function MainTaskComponent() {
  ...
  return (
    <>
      <div className="flex-grow flex justify-center items-start ml-64">
        <div className="grow">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-4 p-4 items-start"> {/* Adjusted items-start */}
              {lists.map((list) => (
                <div
                  key={list}
                  className="bg-gray-100 p-4 rounded-lg shadow-lg w-1/3" // Removed flex-1
                >
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <button
                      ...
                      title={sortOrders[list] === "Oldest" ? "Sort by Newest First" : "Sort by Oldest First"}
                    >
                      {sortOrders[list] === "Oldest" ? (
      ...
      {isOpen && <TaskModal isOpen={isOpen} setIsOpen={setIsOpen} taskData={taskData} />}
    </>
  );
}
